...
#check PUI amount R with itemids
PUIF$chartsitecount2[PUI$maxsiteitemid==576]<-1
PUIF$chartsitecount2[PUI$maxsiteitemid==554]<-2
PUIF$chartsitecount2[PUI$maxsiteitemid==577]<-3
PUIF$chartstagecount2[PUI$maxstageitemid==551]<-1
PUIF$chartstagecount2[PUI$maxstageitemid==552]<-2
PUIF$chartstagecount2[PUI$maxstageitemid==553]<-3
PUIF$chartstagecount2[PUI$maxstageitemid==224631]<-1
PUIF$chartstagecount2[PUI$maxstageitemid==224965]<-2  
PUIF$chartstagecount2[PUI$maxstageitemid==224966]<-3
PUIF$chartstagecount2[PUI$maxstageitemid==224967]<-4
PUIF$chartstagecount2[PUI$maxstageitemid==224968]<-5
PUIF$chartstagecount2[PUI$maxstageitemid==224969]<-6
PUIF$chartstagecount2[PUI$maxstageitemid==224970]<-7
PUIF$chartstagecount2[PUI$maxstageitemid==224971]<-8
PUIF$chartstagecount2[PUI$maxstageitemid==227618]<-9
PUIF$chartstagecount2[PUI$maxstageitemid==227619]<-10
...
#Carevue PUI2 site&stage n differences by features
PUIFc2<-PUIF[(PUIF$carevue==1&is.na(PUIF$metavision)),]
PUIFc2$chartsitecount2[is.na(PUIFc2$chartsitecount2)]<-0
PUIFc2$chartstagecount2[is.na(PUIFc2$chartstagecount2)]<-0
PUIFc2$chartsitestagediff2<-PUIFc2$chartsitecount2-PUIFc2$chartstagecount2
table(PUIFc2$chartsitestagediff2)
PUIFc2$chartsitestagediffR2<-ifelse(PUIFc2$chartsitestagediff2==0,0,1)
#compare metavision PUI2 ICD&stage n differences by features
PUIFm2<-PUIF[(!is.na(PUIF$metavision)&is.na(PUIF$carevue)&!is.na(PUIF$nicdstage)),]
table(PUIFm2$nicdstage,PUIFm2$chartstagecount2, exclude=NULL)
PUIFm2$ICDchartstagediff2<-PUIFm2$nicdstage-PUIFm2$chartstagecount2
table(PUIFm2$ICDchartstagediff2)
PUIFm2$ICDchartstagediffR2<-ifelse(PUIFm2$ICDchartstagediff2==0,0,1)
...
#save data
saveRDS(PUIFc2, file = "PUIFc2.Rds")
save.image("C:/Users/wzhan61/OneDrive - Emory University/Documents/Postdoc/Research/Collabrations/Data center/Vicki's projects/NSF/MIMIC III/data analysis/PUI/PUIFc2.RData")
#save data
saveRDS(PUIFm2, file = "PUIFm2.Rds")
save.image("C:/Users/wzhan61/OneDrive - Emory University/Documents/Postdoc/Research/Collabrations/Data center/Vicki's projects/NSF/MIMIC III/data analysis/PUI/PUIFm2.RData")
